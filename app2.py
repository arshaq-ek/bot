...
# --- Face Detection Setup using Haar Cascades ---
...
def send_command(command):
    if SIMULATION_MODE:
        ...
        # Actual Bluetooth/serial code would go here.
        pass
...
def capture_face():
    global latest_frame, images, classnames
...
# Create the main Tkinter window with dark theme
